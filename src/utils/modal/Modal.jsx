...
const Modal = () => {
    return (
        ...
        <div id="defaultModal" tabIndex="-1" aria-hidden="true" className="block fixed top-0 left-0 right-0 z-50  w-full p-4 overflow-x-hidden  overflow-y-auto md:inset-0 h-modal md:h-full bg-cgray">
