...
const DefaultView = (props) => {
	...
	return (
		<div className='w-10/12 container mx-auto flex justify-between '>
			...
			<div className=' w-[29%] h-[550px] mt-16 border-black text-cblue border-2 rounded-2xl drop-shadow dark:border-white dark:text-slate-50'>
				<div className=' border-b-2 border-black px-8 py-4 text-2xl font-semibold dark:border-white'>
					{t('Filter')}
				</div>
				<div className='px-8'>
					<h3 className='mt-5 mb-4 font-semibold text-lg'>{t('Type')}</h3>
					...
					<h3 className='mt-5 mb-4 font-semibold text-lg'>{t('Status')}</h3>
